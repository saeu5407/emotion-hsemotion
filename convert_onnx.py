...
if not os.path.isfile("hsemotion.onnx"):
    ...
    net = torch.load(model_path, map_location=torch.device('cpu')) # timm==0.6.3
    net.eval()
    ...
    torch.onnx.export(model,  # 실행될 모델
                      ...
                      "/Users/dkcns/PycharmProjects/emotion-hsemotion/hsemotion.onnx",  # 모델 저장 경로 (파일 또는 파일과 유사한 객체 모두 가능)
